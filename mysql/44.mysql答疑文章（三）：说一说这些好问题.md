...
在第 35 篇文章《join 语句怎么优化？》中，我在介绍 join 执行顺序的时候，用的都是 straight_join。
...
![图 1 两个 join 的查询结果](./mysql44-1.png)
...
![图 2 Q1 的 explain 结果](./mysql44-2.png)
...
![图 3 left join -BNL 算法](./mysql44-3.jpg)



<center>图 3 left join -BNL 算法</center>
...
![图 4 Q2 的 explain 结果](./mysql44-4.png)

<center>图 4 Q2 的 explain 结果</center>
...
![图 5 Q2 的改写结果](./mysql44-5.png)

<center>图 5 Q2 的改写结果</center>
...
![图 6 join 语句改写](./mysql44-6.png)

<center>图 6 join 语句改写</center>
...
![图 7 insert 语句的 binlog](./mysql44-7.png)

<center>图 7 insert 语句的 binlog</center>
