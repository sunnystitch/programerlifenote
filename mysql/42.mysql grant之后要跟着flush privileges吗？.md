...
![图 1 mysql.user 数据行](./mysql42-1.png)
...
![图 2 mysql.db 数据行](./mysql42-2.png)
...
![图 4 使用 flush privileges](./mysql42-4.png)
...
![图 5 不规范权限操作导致的异常](./mysql42-5.png)
