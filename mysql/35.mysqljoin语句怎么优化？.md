...
![图 2 MRR 执行流程](./mysql35-2.jpg)

<center>图 2 MRR 执行流程</center>

![图 3 MRR 执行流程的 explain 结果](./mysql35-3.png)

<center>图 3 MRR 执行流程的 explain 结果</center>
...
![图 4 Index Nested-Loop Join 流程图](./mysql35-4.jpg)

<center>图 4 Index Nested-Loop Join 流程图</center>
...
![图 5 Batched Key Access 流程](./mysql35.png)

<center>图 5 Batched Key Access 流程</center>
...
![图 6 explain 结果](./mysql35-6.png)

<center> 图 6 explain 结果</center>

![图 7 语句执行时间](./mysql35-7.png)

<center>图 7 语句执行时间</center>
...
![图 8 使用临时表的执行效果](./mysql35-8.png)

<center>图 8 使用临时表的执行效果</center>
