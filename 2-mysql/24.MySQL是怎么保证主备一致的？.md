...
![图 1 MySQL 主备切换流程](./mysql24-1.png)
...
![图 3 statement 格式 binlog 示例](./mysql24-3.png)

<center>图 3 statement 格式 binlog 示例</center>
...
![图 4 delete 执行 warnings](./mysql24-4.png)

<center>图 4 delete 执行 warnings</center>
...
![图 5 row 格式 binlog 示例](./mysql24-5.png)

<center>图 5 row 格式 binlog 示例</center>
...
![图 6 row 格式 binlog 示例的详细信息](./mysql24-6.png)

<center>图 6 row 格式 binlog 示例的详细信息</center>
...
![图 7 mixed 格式和 now()](./mysql24-7.png)

<center>图 7 mixed 格式和 now()</center>

可以看到，MySQL 用的居然是 statement 格式。你一定会奇怪，如果这个 binlog 过了 1 分钟才传给备库的话，那主备的数据不就不一致了吗？

接下来，我们再用 mysqlbinlog 工具来看看：

![图 8 TIMESTAMP 命令](./mysql24-8.png)

<center>图 8 TIMESTAMP 命令</center>
...
![图 9 MySQL 主备切换流程 -- 双 M 结构](./mysql24-9.png)

<center>图 9 MySQL 主备切换流程 -- 双 M 结构</center>
