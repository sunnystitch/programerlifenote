...
![图 2 一主多从基本结构 -- 主备切换](./mysql27-2.png)

<center>图 2 一主多从基本结构 -- 主备切换</center>
...
![图 3 mysqlbinlog 部分输出结果](./mysql27-3.png)

<center>图 3 mysqlbinlog 部分输出结果</center>
...
![图 4 初始化数据的 binlog](./mysql27-4.png)

<center>图 4 初始化数据的 binlog</center>
...
![图 5 show master status 结果](./mysql27-5.png)

<center>图 5 show master status 结果</center>
