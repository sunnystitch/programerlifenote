...
![图 1 并发 insert 场景](./mysql40-1.png)
...
![图 2 慢查询日志 -- 将数据插入表 t2](./mysql40-2.png)

<center>图 2 慢查询日志 -- 将数据插入表 t2</center>
...
![图 3 慢查询日志 -- 将数据插入表 t](./mysql40-3.png)

<center>图 3 慢查询日志 -- 将数据插入表 t</center>
...
![图 4 explain 结果](./mysql40-4.png)

<center>图 4 explain 结果</center>
...
![图 5 查看 Innodb_rows_read 变化](./mysql40-5.png)

<center>图 5 查看 Innodb_rows_read 变化</center>
...
![图 6 唯一键冲突加锁](./mysql40-6.png)

<center>图 6 唯一键冲突加锁</center>
...
![图 7 唯一键冲突 -- 死锁](./mysql40-7.png)

<center>图 7 唯一键冲突 -- 死锁</center>
...
![图 8 状态变化图 -- 死锁](./mysql40-8.jpg)

<center>图 8 状态变化图 -- 死锁</center>
...
![图 9 两个唯一键同时冲突](./mysql40-9.png)

<center>图 9 两个唯一键同时冲突</center>
